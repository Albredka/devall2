...
public class ProvaBiblioteca
{
   private static void missatgeAfegir (int error, Fitxa obj)
   {
      ...
      else if (error==-3) System.out.println("   No afegit per no tenir espai.");
      else System.out.println("   Refer�ncia "+obj.getReferencia()+" existent a la posici� "+error);
   }
   
   public static void main(String args[])
   {
      Biblioteca b = new Biblioteca(50);
      Revista r = new Revista("MC001","Mundo Cient�fico", 2005, 1);
